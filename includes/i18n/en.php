...
// TOTP Page
    ...
    "years" => "Years",
    "one_time" => "One-time",
    "add_new_insurance" => "Add Insurance",
    "insurance_payment" => "Insurance Payment",
    "insurance_renewal" => "Insurance Renewal",
    "payment_frequency" => "Payment Frequency",
    "next_payment_date" => "Next Payment Date",
    "premium_paying_frequency" => "Premium Paying Frequency",
    "insurance_type" => "Insurance Type",
    "add_insurance" => "Add Insurance",
    "insurance_summary" => "Insurance Summary",
    "view_all_insurances" => "View all insurances",
    "no_active_insurances" => "No active insurances yet",
    "insurance_statistics" => "Insurance Statistics",
    "total_premium_annual" => "Total Annual Premium",
    "policies" => "policies",
    "no_insurance_data" => "No insurance data yet",
    "renewal" => "Renewal",
